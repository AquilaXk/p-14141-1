...
test("상세 페이지 콜아웃과 토글 블록은 작성 문법대로 렌더된다", async ({ page }) => {
  ...
  await expect(page.locator(".aq-callout.aq-admonition-info")).toBeVisible()
  await expect(page.locator(".aq-callout.aq-admonition-info .aq-callout-title")).toHaveText("추가 정보")
