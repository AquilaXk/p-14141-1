...
class MemberRepositoryTest {
    ...
    private fun usernamesBy(kw: String): List<String> = search(kw).content.map(Member::username)

    private fun nicknamesBy(kw: String): List<String> = search(kw).content.map(Member::nickname)
